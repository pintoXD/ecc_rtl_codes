...
export DESIGNS="tbec_full" ;# put here the name of current design
...
# export LIB_VERILOG_FILES=/home/tools/cadence/gpdk/gsclib045_svt_v4.4/lan/flow/t1u1/reference_libs/GPDK045/gsclib045_svt_v4.4/gsclib045/verilog
...
if [ $1 == "-xrun_compiled" ]; then
    # Para executar o XCELIUM
    echo "Running xcelium using the HDL files generated from the Genus' synthesis"
    cd ${PROJECT_DIR}/frontend/work
...
if [ $1 == "-innovus" ]; then
    ...
    echo "RUnning the Innovus physical synthesis tool to synthesize the current design"
