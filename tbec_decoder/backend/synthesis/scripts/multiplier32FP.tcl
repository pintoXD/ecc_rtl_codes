...
report_timing -from product_o_reg[1]/CK -to product_o_reg[1]/D > ${RPT_DIR}/${HDL_NAME}_timing_product_o_reg.rpt
...
report_power -unit uW > ${RPT_DIR}/${HDL_NAME}_MAX_VCD_power.rpt

read_vcd -static -vcd_scope ${DESIGNS}_tb/DUT ${PROJECT_DIR}/frontend/work/${DESIGNS}_MIN_tb.vcd
report_power -unit uW > ${RPT_DIR}/${HDL_NAME}_MIN_VCD_power.rpt
